...
public class HomePageTest extends TestBase {
	...
	/*
	 * @BeforeMethod public void setUp(){ driver=BrowserFactory.browserSetUp(
	 * configDataProvider.getKey("browser"), configDataProvider.getKey("qaUrl"));
	 * //login=PageFactory.initElements(driver,LoginPage.class ); login=new
	 * LoginPage(driver); homepage=login.verifyLoginIntoAnApplication(
