...
public class LoginPageTest extends TestBase {
	...
	/*
	 * @Test(dataProvider="getData") public void verifyLoginTest(String uname,
	 * String upass){
	 * 
	 ...
	 * excelDataProvider.getExcelData("login_smoke"); }
	 */

	@Test(priority = 1)
	public void verifyLoginPageTitleTest() {
		String actualTitle = login.verifyLoginPageTitle(driver);
...
//	}
	...
	public void verifyLoginIntoAnApplicationTest() {
		login.verifyLoginIntoAnApplication(configDataProvider.getKey("uname"), configDataProvider.getKey("upass"));
